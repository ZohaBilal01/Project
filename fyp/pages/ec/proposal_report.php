   ...
   include('header.php');
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <div class="form-group p-1 rounded">
        <h4 class="text-center btn btn-success btn-block btn-user btn-block">Evaluate Group Proposal Report</h4>
		...
		<?php
            ...
            $user=$sql5['user_id'];
            $sql3=mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM evaluate_proposal WHERE group_id='$group_id;'"));
			?>
			<tr>
                <td><?php echo $group_id; ?></td>
                <td><?php echo $sql2; ?></td>
				<td><?php echo $sql5['project_title'];?></td>  
                <td><?php echo $sql3['status']; ?></td>				
                <td><?php echo $sql3['remarks'];?></td>  
                <td><a href="pro_delete.php?evaluate_proposal_id=<?php echo $group_id; ?>" class="btn btn-danger">Delete</a></td>
