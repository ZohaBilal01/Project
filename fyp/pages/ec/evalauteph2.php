   ...
   include('header.php');
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <div class="form-group p-1 rounded">
        <h4 class="text-center btn btn-success btn-block btn-user btn-block">Evaluate <?php echo $name; ?> Phase 2 </h4>
				...
				<div class="form-group">
                <input type="text" name="ph2_remarks" class="form-control" placeholder="Remarks" required>
        </div>
        ...
        <div class="form-group d-none">
                ...
                <hr>
				<div class="form-group ">
                <button type="submit" name="evaluate_phase2" class="btn btn-success btn-block btn-user btn-block">Evaluate</button>
				</div>			
                </form>                      
           </div>
           </div>
