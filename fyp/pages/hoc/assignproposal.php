   ...
   include('header.php');
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="form-group p-1 rounded">
        <h4 class="text-center btn btn-success btn-block btn-user btn-block">Assign Proposal For Evaluation </h4>
		...
		<?php
           ...
           $user=$query['user_id'];
           $query1=mysqli_fetch_assoc(mysqli_query($con,"select * from proposal where user_id='$user'"));
			...
			<tr>
				...
				<td><a href="selectec.php?group_id=<?php echo $group_id; ?>" class="btn btn-success">Assign</a> 
				</td>
			</tr>
			<?php
