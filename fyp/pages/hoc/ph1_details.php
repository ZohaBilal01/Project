<?php 
   ...
   include('header.php');
    ...
    <h4 class="btn btn-success btn-block btn-user btn-block">Phase 1 Information</h4>
...
if($sql3)
{
        ...
        <td><a href="phase1_status.php?group_id=<?php echo $group_id; ?>" class="btn btn-info">Status Report</a></td>
      </tr>
      <?php
}
      ?>
