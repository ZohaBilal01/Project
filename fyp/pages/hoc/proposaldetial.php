<?php 
   ...
   include('header.php');
    ...
    <h4 class="btn btn-success btn-block btn-user btn-block">Proposals Information</h4>
...
if($sql3)
{
        ...
        <td><a href="proposal_status.php?group_id=<?php echo $group_id; ?>" class="btn btn-info">Status Report</a></td>
      </tr>
      <?php
}
      ?>
