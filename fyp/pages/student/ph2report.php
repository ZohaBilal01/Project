<?php 
   ...
   include('header.php');
    ...
    if(isset($_GET['notify']))
    {
      ...
      $group_sort=$sql1['group_id'];
      $update=mysqli_query($con,"UPDATE evaluate_phase2 SET marker=0 WHERE group_id='$group_sort' && user_id='$status'");
    }
    ?>
    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="col-md-12 bg-light p-4 rounded nt-5"><hr>
        <h4 class="btn btn-success btn-block btn-user btn-block">Phase 2 Upload Report </h4>
...
if($sql3)
{
      ...
      ?>
        ...
        <h4 class="btn btn-success btn-block btn-user btn-block">Phase 2 Status Report </h4>
        <table width="100%" class="table table-striped  table-hover" >
        <thead>
            <tr class="table-btn btn-success">
                <th scope="col">Group ID</th>
		...
		<tbody>
		<?php
    $sql6=mysqli_query($con,"SELECT * FROM evaluate_phase2 WHERE group_id='$group_id' && user_id='$status'");
    $counter=mysqli_num_rows($sql6);
...
if($counter > 0)
{
			...
			<tr>
                ...
                <td><?php echo $sql2; ?></td>
                <td><?php echo $sql3['upload_file']; ?></td>
                <td><?php echo $sql4['ph2_marks']; ?></td>				
                <td><?php echo $sql4['remarks'];?></td>         
			</tr>
    <?php
}
?>
