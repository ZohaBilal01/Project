<?php 
   ...
   include('header.php');
    ...
    if(isset($_GET['notify']))
    {
      ...
      $update=mysqli_query($con,"UPDATE evaluate_proposal SET marker=0 WHERE group_id='$group_sort'");
    }
    ?>
    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <h4 class="btn btn-success btn-block btn-user btn-block">Proposal Upload Report </h4>
...
$user=$sql5['user_id'];
$sql3=mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM proposal WHERE user_id='$user'"));
if($sql3)
{
			?>
			<tr>
      ...
      ?>
		...
		<tbody>
    <?php
    $sql6=mysqli_query($con,"SELECT * FROM evaluate_proposal WHERE group_id='$group_id'");
