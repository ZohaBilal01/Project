      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
                ...
                <table width="100%" class="table table-striped  table-hover" >
			      ...
			      ?>
			     <tr>
                <td><input type="hidden" id="startdate<?php echo $row['startdate']; ?>" value="<?php echo $row['startdate']; ?>"><?php echo $row['startdate']; ?></td>
				<td><input type="hidden" id="enddate<?php echo $row['enddate']; ?>" value="<?php echo $row['enddate']; ?>"><?php echo $row['enddate']; ?></td>
			   </tr>
			<?php
			}
		    ?>
			    ...
			    <?php			    
			    if(isset($_SESSION['phase2_msg'])){
				echo $_SESSION['phase2_msg'];
				unset($_SESSION['phase2_msg']);
			    }
		     	?>
				</div>
                </div><hr>
				<div class="form-group ">
                <button type="submit" name="phase2" class="btn btn-success btn-block btn-user btn-block">Submit</button>
				</div>
                </form>
       <div class="form-group p-1 rounded">
        <table width="100%" class="table table-striped  table-hover" >
